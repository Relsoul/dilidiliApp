...
;(function(root, factory) {
    ...
    function Plyr(media, config) {
        ...
        function _controlListeners() {
            ...
            _on(document.body, 'tap', function() {
            ...
            // Play
            _proxyListener(plyr.buttons.play, 'tap', config.listeners.play, togglePlay);

            // Pause
            _proxyListener(plyr.buttons.pause, 'tap', config.listeners.pause, togglePlay);

            // Restart
            _proxyListener(plyr.buttons.restart, 'tap', config.listeners.restart, _seek);

            // Rewind
            _proxyListener(plyr.buttons.rewind, 'tap', config.listeners.rewind, _rewind);

            // Fast forward
            _proxyListener(plyr.buttons.forward, 'tap', config.listeners.forward, _forward);
            ...
            // Mute
            _proxyListener(plyr.buttons.mute, 'tap', config.listeners.mute, _toggleMute);

            // Fullscreen
            _proxyListener(plyr.buttons.fullscreen, 'tap', config.listeners.fullscreen, _toggleFullscreen);
            ...
            // Captions
            _on(plyr.buttons.captions, 'tap', _toggleCaptions);
